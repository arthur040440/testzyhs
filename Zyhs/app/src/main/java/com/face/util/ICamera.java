...
public class ICamera {
    ...
    public Camera openCamera(boolean isBackCamera, Activity activity, HashMap<String, Integer> resolutionMap) {
        try {
            ...
            int width = 640;// 可以设置880
            int height = 480;// 可以设置660
    ...
    public ConstraintLayout.LayoutParams getLayoutParam() {
        ...
        ConstraintLayout.LayoutParams layout_params = new ConstraintLayout.LayoutParams(layout_width, layout_height);

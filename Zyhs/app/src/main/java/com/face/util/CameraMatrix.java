...
//	public ArrayList<ArrayList> points = new ArrayList<ArrayList>();
	...
	// vertex
	// 直角坐标系
//	static float squareCoords[] = { -1.0f, 1.0f, -1.0f, -1.0f, 1.0f, -1.0f, 1.0f, 1.0f, };// 头朝右
	static float squareCoords[] = { -1.0f, -1.0f, 1.0f, -1.0f, 1.0f, 1.0f, -1.0f, 1.0f, };// 头朝上
//	static float squareCoords[] = { 1.0f, 1.0f, -1.0f, 1.0f, -1.0f, -1.0f, 1.0f, -1.0f };// 头朝下

 ...
 * 描述:第二个展示页面
 */
public class SecondLauncherFragment extends LauncherBaseFragment implements View.OnClickListener {

    private String Tag = SecondLauncherFragment.class.getSimpleName();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if (started)
                                ...
                                EventBus.getDefault().post(new LauncherModel(2));
                        }
                    }, 5000);
            }
        });

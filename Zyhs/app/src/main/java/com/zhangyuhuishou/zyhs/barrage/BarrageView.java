package com.zhangyuhuishou.zyhs.barrage;
...
//    private boolean isRandomDistanTime = true; //是否随机间隔时间
    ...
    private void addView(BarrageViewBean barrageViewBean) {
        ...
        if (itemLayoutParams == null) {
            itemLayoutParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        }

 ...
 * 描述: 轮询测试
 */
public class PollingTestActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        queryAllTime = doorTimes * 2 * 2 + lampTimes * 2 * 2 + sjTime * 2 * 2 + funTime * 6 + funTime * 2;
    ...
    private void sendPolling() {
        ...
        Observable.interval(queryAllTime, TimeUnit.SECONDS).subscribeOn(Schedulers.io()).subscribe(disposableObserver);
    ...
    private void sendPollingPackage() {
        ...
        pollingTimeQueryUtils.doOpenLamp();
        pollingTimeQueryUtils.doCloseLamp();
        pollingTimeQueryUtils.doOpenShaJunByTest();
        pollingTimeQueryUtils.doCloseShaJunByTest();
        pollingTimeQueryUtils.doOpenFan();
        pollingTimeQueryUtils.doCloseFan();
    }

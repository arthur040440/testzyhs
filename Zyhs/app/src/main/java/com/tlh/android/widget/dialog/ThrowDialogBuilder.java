 ...
 * @desc 中间弹框
 */
public class ThrowDialogBuilder implements OnClickListener {

    private Context mContext;
    private ThrowDialog mDialog;
    ...
    public ThrowDialogBuilder(Context context) {
        mContext = context;
        displayMetrics = context.getResources().getDisplayMetrics();
        mClickMaps = new SparseArray<OnClickListener>();
    }

    public ThrowDialogBuilder setLayoutId(int layoutId) {
        mLayoutId = layoutId;
        return this;
    }

    public ThrowDialogBuilder setLayoutId(View view) {
        mLayoutView = view;
        return this;
    }

    public ThrowDialogBuilder setLayoutIdVisible(int id) {
        View button = mLayoutView.findViewById(id);
        button.setVisibility(View.GONE);
        return this;
    }

    public ThrowDialogBuilder setOnClickListener(int buttonId, OnClickListener listener) {
        mClickMaps.put(buttonId, listener);
        return this;
    }

    public ThrowDialogBuilder setClickDismiss(boolean dismiss) {
    ...
    private Dialog create() {
        ...
        if (mDialog == null) {
            mDialog = new ThrowDialog(mContext, R.style.gc_botttom_menu_dialog);
            if (mLayoutView == null) {
    ...
    // 点击对话框外部是否消失
    public ThrowDialogBuilder setCanceledOnTouchOutside(boolean cancel) {
        mDialog.setCanceledOnTouchOutside(cancel);
        return this;
    }

    // 设置对话框的显示位置
    public ThrowDialogBuilder setGravity(int gravity) {
    ...
    // 设置对话框动画
    public ThrowDialogBuilder setAnimation(int style) {
        Window window = mDialog.getWindow();
    ...
    // 设置点击返回按钮消失或者不消失
    public ThrowDialogBuilder setCancelable(boolean flag) {
        if (mDialog != null) {

...
//		paint.setColor(Color.parseColor("#FFffc600"));
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		Shader mShader = new LinearGradient( width/2.0f,height,width/ 2.0f, 0, new int[] {getResources().getColor(R.color.theme_color,null), Color.TRANSPARENT}, null, Shader.TileMode.CLAMP);

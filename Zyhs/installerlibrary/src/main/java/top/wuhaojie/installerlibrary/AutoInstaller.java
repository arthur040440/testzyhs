...
public class AutoInstaller extends Handler {
    ...
    private final String TAG = "AutoInstaller";
    ...
    public interface OnStateChangedListener {
        ...
        void onFileLength(int fileLength);
    }
        ...
        switch (msg.what) {
            ...
            case 4:
                if (mOnStateChangedListener != null){
                    ...
                    mOnStateChangedListener.onDownloadProgress(progress);
                }
                break;
            case 5:
                if (mOnStateChangedListener != null){
                    ...
                    mOnStateChangedListener.onFileLength(fileLength);
                }
                break;
        }
    }
    ...
    private File downLoadFile(String httpUrl) {
        ...
        try {
            ...
            Bundle lengthData = new Bundle();
            lengthData.putInt("fileLength",fileLength);
            Message msgLength = new Message();
            msgLength.setData(lengthData);
            msgLength.what = 5;
            sendMessage(msgLength);
